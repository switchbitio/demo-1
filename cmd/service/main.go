...
import (
	...
	"github.com/upbound/demo-1/internal"
	"github.com/upbound/demo-1/internal/runtime"
	"github.com/upbound/demo-1/internal/server/api"
	"github.com/upbound/demo-1/internal/server/metrics"
	"github.com/upbound/demo-1/internal/server/private"
)

func main() {
	opts := internal.ServiceOptions{}

	ctx := kong.Parse(&opts, kong.Name("demo-1"),
		kong.Description("Upbound demo-1"),
		kong.UsageOnError(),
	...
	zl := zap.New(zapOpts...)
	opts.Log = logging.NewLogrLogger(zl.WithName("demo-1"))
