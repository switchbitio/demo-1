...
import (
	...
	shttp "github.com/upbound/demo-1/internal/client/http"
	serrors "github.com/upbound/demo-1/internal/errors"
	"github.com/upbound/demo-1/internal/types"
)
...
// ACL is the ACL that is returned by the external ACL demo-1.
type ACL struct {
