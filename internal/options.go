...
// ProductMetricsOptions are common options for consumers of the accounts demo-1.
type ProductMetricsOptions struct {
	Host url.URL `name:"product-metrics-host" default:"http://product-metrics-private:8080" help:"Product Metrics demo-1 host."`
}
